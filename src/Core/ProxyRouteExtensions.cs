...
namespace AspNetCore.Proxy
{
    ...
    public static class ProxyExtensions
    {
        ...
        /// <param name="processResponseBody">A handler for process response body before return</param>
        /// <returns>
        ...
        /// </returns>
        public static Task ProxyAsync(this Controller controller, string uri, Func<HttpContext, Exception, Task> onFailure = null, Func<System.IO.Stream, System.IO.Stream> processResponseBody = null)
        {
            return Helpers.HandleProxy(controller.HttpContext, uri, onFailure, processResponseBody);
        }
        ...
        /// <param name="onFailure">A lambda to handle proxy failures { (context, exception) => Task }.</param>
        /// <param name="processResponseBody">A lambda to process response body { (responseStream) => Stream }.</param>
        public static void UseProxy(this IApplicationBuilder app, string endpoint, Func<IDictionary<string, object>, Task<string>> getProxiedAddress, Func<HttpContext, Exception, Task> onFailure = null, Func<System.IO.Stream, System.IO.Stream> processResponseBody = null)
        {
            Func<HttpContext, IDictionary<string, object>, Task<string>> gpa = (context, args) => getProxiedAddress(args);

            UseProxy(app, endpoint, gpa, onFailure, processResponseBody);
        }
        ...
        /// <param name="onFailure">A lambda to handle proxy failures { (context, exception) => Task }.</param>
        /// <param name="processResponseBody">A lambda to process response body { (responseStream) => Stream }.</param>
        public static void UseProxy(this IApplicationBuilder app, string endpoint, Func<Task<string>> getProxiedAddress, Func<HttpContext, Exception, Task> onFailure = null, Func<System.IO.Stream, System.IO.Stream> processResponseBody = null)
        {
        ...
        /// <param name="processResponseBody">A lambda to process response body { (responseStream) => Stream }.</param>
        public static void UseProxy(this IApplicationBuilder app, string endpoint, Func<HttpContext, IDictionary<string, object>, string> getProxiedAddress, Action<HttpContext, Exception> onFailure = null, Func<System.IO.Stream, System.IO.Stream> processResponseBody = null)
        {
        ...
        /// <param name="onFailure">A lambda to handle proxy failures { (context, exception) => void }.</param>
        /// <param name="processResponseBody">A lambda to process response body { (responseStream) => Stream }.</param>
        public static void UseProxy(this IApplicationBuilder app, string endpoint, Func<IDictionary<string, object>, string> getProxiedAddress, Action<HttpContext, Exception> onFailure = null, Func<System.IO.Stream, System.IO.Stream> processResponseBody = null)
        {
        ...
        /// <param name="onFailure">A lambda to handle proxy failures { (context, exception) => void }.</param>
        /// <param name="processResponseBody">A lambda to process response body { (responseStream) => Stream }.</param>
        public static void UseProxy(this IApplicationBuilder app, string endpoint, Func<string> getProxiedAddress, Action<HttpContext, Exception> onFailure = null, Func<System.IO.Stream, System.IO.Stream> processResponseBody = null)
        {
